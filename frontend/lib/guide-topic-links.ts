...
const TOPIC_GUIDE_OVERRIDES: Record<string, string> = {
  ...
  "agents.md vs copilot-instructions.md": "agents-md-vs-claude-md-cursorrules-copilot-instructions",
  "agents md vs copilot instructions": "agents-md-vs-claude-md-cursorrules-copilot-instructions",
  ...
  "ai coding config files": "ai-coding-config-files-guide",
  "ai coding configuration files": "ai-coding-config-files-guide",
  "coding agent instruction files": "ai-coding-config-files-guide",
  "ai assistant config files": "ai-coding-config-files-guide",
  "agents.md claude.md gemini.md": "ai-coding-config-files-guide",
  "copilot instructions cursor rules windsurf rules": "ai-coding-config-files-guide",
  "copilot instructions vs cursor rules": "agents-md-vs-claude-md-cursorrules-copilot-instructions",
