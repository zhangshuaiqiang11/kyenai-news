...
export const brandEntities: BrandEntity[] = [
  ...
  },
  {
    ...
    sourceType: "official",
    relationship: "Aerospace company named as the buyer in KyenAI's source-backed Cursor acquisition coverage.",
    mentionPolicy: MENTION_POLICY,
    coverageStatus: "covered",
    coveredArticleSlugs: [],
  },
  {
    ...
    slug: "anysphere",
    kind: "Organization",
    officialUrl: "https://anysphere.inc/",
    sourceType: "official",
    relationship: "Applied research company behind Cursor and the target named in KyenAI's transaction coverage.",
    mentionPolicy: MENTION_POLICY,
    coverageStatus: "covered",
    coveredArticleSlugs: [],
  },
