  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: "source_note",
        content:
          "Evidence boundary: Cursor's Security page was updated August 25, 2026 and its Data Use page August 28, 2026; KyenAI rechecked the three cited sources on September 8, 2026. Privacy Mode excludes customer data from training and Cursor describes provider ZDR agreements, but abuse-detection exceptions and non-ZDR model opt-ins remain. This page does not claim a universal retention result or control availability for every model, workspace, client, region, or contract.",
        sourceIds: ["src-cursor-enterprise-orgs", "src-cursor-security", "src-cursor-data-use"],
      },
    ],
    sources: [
      {
        ...
        verificationChangeNote: "Rechecked the June 3 enterprise organization launch and recorded the permissive-membership caveat.",
      },
      {
        ...
        verificationChangeNote: "Updated the evidence boundary to the current published page date.",
      },
      {
        ...
        verificationChangeNote: "Preserved retention exceptions and removed any implication of an unconditional universal zero-retention result.",
      },
    ],
    publishedAt: "2026-06-03T09:00:00Z",
